...
const ringTexts = [
  'С днем рождения тебя',//untuk deskripsi planet layer 1
  "Я очень люблю тебя",//untuk deskripsi planet layer 2
  "встреча с тобой - это лучшее, что случалось со мной",//untuk deskripsi planet layer 3
  "С любовью от меня в твой день рождения",//untuk deskripsi planet layer 4
...
function preloadGalaxyAudio() {
  const audioSources = [
   "https://www.youtube.com/watch?v=pd6DgbvUqBc&list=RDpd6DgbvUqBc&start_radio=1"
  ];
